...
W_m2_g_conv3 = tf.Variable(xavier_init([3,3,16,32]))
b_m2_g_conv3 = tf.Variable(tf.zeros(shape=[16]))

W_m2_g_conv4 = tf.Variable(xavier_init([5,5,1,16]))
...
#==================== Discriminator ====================
#Encoder 1
W_m1_e_conv1 = tf.Variable(xavier_init([5,5,1,8]))
b_m1_e_conv1 = tf.Variable(tf.zeros(shape=[8]))

W_m1_e_conv2 = tf.Variable(xavier_init([3,3,8,16]))
b_m1_e_conv2 = tf.Variable(tf.zeros(shape=[16]))

W_m1_e_fc3 = tf.Variable(xavier_init([7*7*16, 128]))
b_m1_e_fc3 = tf.Variable(tf.zeros(shape=[128]))

W_m1_e_fc4_z = tf.Variable(xavier_init([128, z_dim]))
b_m1_e_fc4_z = tf.Variable(tf.zeros(shape=[z_dim]))

W_m1_e_fc4_c = tf.Variable(xavier_init([128, c_dim]))
...
W_m2_e_fc3 = tf.Variable(xavier_init([7*7*16, 128]))
b_m2_e_fc3 = tf.Variable(tf.zeros(shape=[128]))

W_m2_e_fc4_z = tf.Variable(xavier_init([128, z_dim]))
b_m2_e_fc4_z = tf.Variable(tf.zeros(shape=[z_dim]))

W_m2_e_fc4_c = tf.Variable(xavier_init([128, c_dim]))
